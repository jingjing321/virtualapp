                ...
                for(var i=0;i<collapseHeader.length;i++){
                    (function(e){
                        collapseHeader[e].onclick = function(){
                            if(collapseHeader[e].nextSibling.className.indexOf("aui-collapse-content") > -1){
                                if(collapseHeader[e].nextSibling.className.indexOf("aui-show") > -1){
                                    collapseHeader[e].nextSibling.classList.remove("aui-show");
                                    ...
                                    collapseHeader[e].nextSibling.classList.toggle("aui-show");
